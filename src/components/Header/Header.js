          ...
          <nav className={styles.navBar}>
            ...
            {isOpen && (
              <ul className={styles.dropDownMenu}>
                <li>
                  <Link className={`${styles.navBarLink} ${styles.navBarBlogLink}`} to='/#blog-section'>Blog</Link>
                </li>
                <li>
                  <Link className={`${styles.navBarLink} ${styles.navBarMusicLink}`} to='/#music-section'>Music</Link>
                </li>
                <li>
                  <Link className={`${styles.navBarLink} ${styles.navBarDownloadsLink}`} to='/#downloads-section'>Downloads</Link>
                </li>
              </ul>
            )}
          </nav>
